...
export const api = {
  ...
  listarAcertos: () => get('acertos'),
  listarDespesasAcerto: (acertoId) => get('despesas_acerto', { acerto_id: acertoId }),
  listarCaixinhas: () => get('caixinhas'),
  listarMovimentosCaixinha: (caixinhaId) => get('movimentos_caixinha', { caixinha_id: caixinhaId }),
  ...
  criarCaixinha: (dados) => post({ action: 'criar_caixinha', ...dados }),
  editarCaixinha: (dados) => post({ action: 'editar_caixinha', ...dados }),
  excluirCaixinha: (id) => post({ action: 'excluir_caixinha', id }),
  movimentarCaixinha: (dados) => post({ action: 'movimentar_caixinha', ...dados }),
